 ...
 *   Design.
 * @param {string} antdThemePath - Path to the default LESS variables
 * @return {string} A string representing an SCSS file containing all the theme and color
 *   variables used in Ant Design.
 */
const compileThemeVariables = exports.compileThemeVariables = (themeScssPath, antdThemePath) => {
  const themeEntryPath = require.resolve(antdThemePath);
