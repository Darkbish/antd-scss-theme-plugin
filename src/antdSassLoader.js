...
import { getScssThemePath, getDefaultThemePath } from './loaderUtils'
...
export const overloadSassLoaderOptions = async options => {
  ...
  const defaultThemePath = getDefaultThemePath(options)

  const contents = await compileThemeVariables(scssThemePath, defaultThemePath)
